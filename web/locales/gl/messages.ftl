...
join-newsletter = Opcionalmente, pode unirse á nosa lista para actualizacións e novas informacións sobre o proxecto.

## What's public

whats-public = Que é público?
...
faq-why-important-a =
    ...
    Para facermos o recoñecemento da fala máis universal, estamos a recoller mostras de voz tanto en idiomas amplamente falados como naqueles con menos número de falantes, que adoito carecen de servizos de recoñecemento da fala comerciais. A publicación dun conxunto diverso de datos de voz facilitaralles aos desenvolvedores, emprendedores e a comunidades de falantes enteiras afrontar esta fenda por si mesmos.
faq-how-get-q = Como podo conseguir os datos de Common Voice?
faq-how-get-a = O conxunto de datos de Common Voice está dispoñible para descargar coa licenza <licenseLink>CC0</licenseLink> na <datasetLink>nosa pestana Conxunto de datos</datasetLink>. Tamén pode descargar outros conxuntos de datos dispoñibles publicamente desde a mesma pestana.
faq-when-release2-q = Cando publicará os datos de Common Voice noutros idiomas?
faq-when-release2-a = A versión multilingüe do conxunto de datos de Common Voice está sendo sometida actualmente a un proceso de agrupación e limpeza co apoio da comunidade. Se desexa axudarnos a engadir novos idiomas a Common voice, visite a <sentenceCollectorLink>ferramenta Sentence Collector</sentenceCollectorLink> para engadir novas frases ao conxunto de datos, e o <pontoonLink>PontoonLink</pontoonLink> de Mozilla para traducir a propia páxina. Os novos idiomas engadidos a Common Voice poden comezar a recibir contribucións de voz cando dispoñen de 5000 frases recompiladas e aprobadas.
faq-why-mission-q = Por que forma parte Common Voice da misión de Mozilla?
faq-why-mission-a = Mozilla dedícase a manter a web aberta e accesible para todos. Para facer iso, necesitamos proporcionar ferramentas os creadores de contidos web a través de proxectos como Common Voice. Xa que as tecnoloxías da fala proliferan alén das aplicacións de nicho, cremos que deben servir a todas as persoas equitativamente. Iso significa incluír máis idiomas, máis diversidade de acentos e máis variedade demográfica ao crear e probar as tecnoloxías da fala. Common Voice é un recurso público, dispoñible para todos, e que xa empregan os equipos de desenvolvedores de Mozilla de todo o mundo nos seus propios proxectos.
...
faq-why-not-ask-read-a = Para facermos o conxunto de datos de Common Voice tan útil como sexa posible, decidimos aceptar soamente textos dispoñibles baixo licenza Creative Commons (CC0). Utilizar o estándar CC0 implica que é máis difícil atopar e recoller textos, pero asegura que calquera persoa poida utilizar os datos de voz resultantes sen restricións de uso nin autorización de Mozilla. En última instancia, queremos facer o conxunto de datos multilingüe tan útil como sexa posible para investigadores, universidades, empresas, gobernos, organizacións con fins sociais e afeccionados.
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = <b>Acepto</b> non tentar determinar a identidade dos falantes do conxunto de datos Common Voice
...
demo-language-select-card-body = Grazas ás colaboracións de máis de 259.000 persoas en máis de 50 idiomas, estes datos empréganse para adestrar aplicacións de recoñecemento da fala para entender mellor a voz humana.
...
sc-howto-cite-item-1 = Pode incluír a páxina web, por exemplo "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Pode empregar o estilo de referencia académico. Por exemplo, o estilo de Harvard: "Mozilla (2021) Common Voice. Dispoñible en https://gonthuka3.swecha.org/ (Consulta: 15 de setembro de 2021)"
...
partnerships-governments-description = Estamos encantados de apoiar o compromiso do sector público coa tecnoloxía, a innovación e os dereitos lingüísticos. Se ten previsto poñer en marcha un proxecto ou unha campaña importante, <emailFragment>póñase en contacto connosco.</emailFragment>
...
citing-sentences-subheader-websites-explanation = Pode incluír a páxina web, por exemplo, "Common Voice - https://gonthuka3.swecha.org/"
citing-sentences-subheader-academic-reference = Referencias académicas
citing-sentences-subheader-academic-reference-explanation = Pode empregar o estilo de referencia académico, por exemplo, o estilo Harvard: "Mozilla (2021) Common Voice. Dispoñible en https://gonthuka3.swecha.org/ (Consulta: 15 de setembro de 2021)"
