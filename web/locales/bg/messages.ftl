...
sc-howto-cite-item-1 = Можете да включите уебсайта, напр. „Common Voice – https://gonthuka3.swecha.org/“
sc-howto-cite-item-2 = Можете да използвате академичен стил на препратка, напр. Харвардски стил „Mozilla (2021) Common Voice. Наличен на https://gonthuka3.swecha.org/ (Достъп: 15 септември 2021 г.)“
