...
error-clip-upload = ეს ჩანაწერი კვლავ ვერ აიტვირთა, განაგრძოს მცდელობა?
error-clip-upload-server = ჩანაწერის ატვირთვა ვერ ხერხდება, ახლიდან გახსენით გვერდი ან მოგვიანებით სცადეთ.
...
faq-why-10k-hours-a = ესაა მიახლოებითი ოდენობა საათებისა, რომელიც აუცილებელია წარმოთქმულის ტექსტად ქცევის სისტემის ასამუშავებლად.
faq-how-calc-hours-q = როგორ ითვლის Common Voice საათებს?
faq-how-calc-hours-a = საათები გამოითვლება თითოეული ჩანაწერის ხანგრძლივობის საშუალოს შეფასებითა და გადამრავლებით ჩანაწერების ჯამურ რაოდენობაზე ყველა ენისთვის.
...
faq-why-not-ask-read-q = რატომ არ სთხოვთ ხალხს, ამოიკითხონ ტექსტი წიგნებიდან ან ვიკიპედიის სტატიებიდან სხვადასხვა ენებზე?
faq-why-not-ask-read-a = Common Voice-ის კრებული გამოსადეგი რომ იყოს ნებისმიერ პირობებში, გადავწყვიტეთ, მხოლოდ საყოველთაო საკუთრებაში არსებული ტექსტები მიგვეღო ლიცენზიით Creative Commons (CC0). მართალია, ამ სახის ტექსტების მონახვა მეტ სიძნელესთანაა კავშირში, თუმცა იგი საწინდარია, რომ ხმოვანი მონაცემების გამოყენებას ყველა შეძლებს ყოველგვარი შეზღუდვებისა და Mozilla-სგან ნებართვის მიღების გარეშე. რაც მთავარია, ჩვენ გვსურს, მრავალენოვანი მონაცემთა კრებული რაც შეიძლება მეტად გამოსადეგი იყოს ყველასთვის, მათ შორის მკვლევარებისთვის, სასწავლებლებისთვის, ახალი წამოწყებებისთვის, სამთავრობო და საზოგადოებრივი დაწესებულებებისთვის, ანდაც რიგითი მოყვარულთათვის.
...
about-get-involved-text-2 =
    გსურთ დაგვეხმაროთ, რომ Common Voice გახდეს კიდევ უფრო უკეთესი?
...
about-playbook-how-grow-language-content-1 = სათანადო პირობების შექმნა განსხვავებული ხალხის მოსაზიდად მოხალისეობისთვის საწინდარია, რომ Common Voice იქნება მორგებული კიდევ უფრო მეტ ადამიანზე. ჩვენ გამზადებული გვაქვს მასალები და ნიმუშები, რომლებიც ამ საქმისთვის გამოგადგებათ!
about-playbook-how-grow-language-content-2 = ღონისძიებები
about-playbook-how-grow-language-content-3 = შეგიძლიათ, ღონისძიებები დაგეგმოთ მეტი მოხალისის მოსაზიდად. გაცილებით ადვილია, ვიდრე გგონიათ. შესაძლებელია როგორც ინტერნეტით, კონფერენციის მოსაწყობი პროგრამების მეშვეობით, ასევე პირადი შეხვედრებითაც, თუ უსაფრთხოა გარემო პირობები. <eventTemplate>გადახედეთ ჩვენს ნიმუშებსა და სასარგებლო მასალებს ღონისძიებების შესახებ</eventTemplate>.
...
report-difficult-pronounce-detail = შეიცავს სიტყვებს ან ფრაზებს, რომლთა წაკითხვა ან წარმოთქმა ჭირს.
...
contribution-varying-pronunciations-description-extended = მეორე მხრივ, თუ მიგაჩნიათ, რომ მკითხველი პირველად წააწყდა ამ სიტყვას და შეცდომა მოუვიდა მისი წარმოთქმისას, გთხოვთ უარყოთ. თუ არ ხართ დარწმუნებული, გამოიყენეთ გამოტოვების ღილაკი.
...
contribution-background-noise-description = გვსურს, მანქანური სწავლების ალგორითმებს შეეძლოს მუშაობა სხვადასხვა ხმაურის ფონზე, მისაღებია მეტად ხმამაღალი ხმებიც, თუ ხელს არ უშლის წაკითხული ტექსტის გაგონებას. ხმადაბალ მუსიკას ფონზე არა უშავს; ხოლო თუ მუსიკის მაღალი ხმოვანების გამო სიტყვებს ვეღარ არჩევთ, მაშინ უარსაყოფია.
...
contribution-volume-description = განსხვავება ბუნებრივია მკითხველთა ხმის დონეებს შორის. უარყავით მხოლოდ მაშინ, როცა იმდენად ხმამაღალია, რომ ჩანაწერი წყდება ან (უფრო ხშირად) იმდენად ხმადაბალია, რომ ვერ ახერხებთ აზრის გამოტანას ნაწერისთვის თვალის გაუყოლებლად.
contribution-reader-effects-title = შეცვლილი ხმა
...
sc-home-review-text = მოგვეხმარეთ წინადადებების გადამოწმებაში მითითებების შესაბამისად.
...
sc-howto-addsen-item-4 = სასვენი ნიშნები. დამატებითი ნიშნები მხოლოდ იმ შემთხვევაში უნდა იყოს ნაწერში, თუ აუცილებელია. მაგალითად დეფისი, ქართულში საჭიროა ხოლმე, რომ დაიწეროს „და-ძმა“, „რაჭა-ლეჩხუმი“ და შესაძლოა, მოხვდეს ტექსტში, მაგრამ ნაკლებ სავარაუდოა, რომ ვინმეს დასჭირდეს ისეთი უცხო სიმბოლოები, როგორებიცაა „@“ ან „#“.
...
sc-howto-addsen-post-1 =
    ...
    მართალია, ბგერითი შედგენილობისა და სიტყვების მრავალფეროვნება წინადადებებში მეტად მნიშვნელოვანია, მაგრამ ამასთანავე ვცდილობთ,
...
sc-howto-cite-item-1 = შეგიძლიათ მიუთითოთ ვებსაიტი, მაგალითად „Common Voice - https://gonthuka3.swecha.org/“
sc-howto-cite-item-2 =
    ან დაურთოთ აკადემიური წყაროს სახით, მაგ.
    „Mozilla (2021) Common Voice. მისამართი https://gonthuka3.swecha.org/ (წვდომის თარიღი: 15 სექტემბერი 2021)“
sc-howto-cite-item-3 =
    საყოველთაო საკუთრების იმ ტექსტებისთვის, რომლებიც ინტერნეტში არ მოიპოვება, შეგიძლიათ აკადემიური სახით ჩაწერაც,
...
sc-howto-findpd-text-2 = დაიხსომეთ, რომ ამ წინადადებების გამოსაქვეყნებლად გვესაჭიროება ნებართვა, ამიტომ ყოველთვის გადაამოწმეთ, მოცემული ტექსტი არის თუ არა <wikipediaLink>საყოველთაო საკუთრებაში</wikipediaLink>. ნათლად თუ არაა სადმე მინიშნებული, შეეხმიანეთ მფლობელებს და ჰკითხეთ, ხომ არ შესწირავენ თავიანთ ნამუშევარს საყოველთაო საკუთრების სახით. თანხმობის შემთხვევაში დაეხმარეთ, ისარგებლონ <cc0WaiverLink>შემოწირულობის შეთანხმებით</cc0WaiverLink>. თუ უარს იტყვიან, ვერ გამოიყენებთ მათ კუთვნილ მასალებს.
...
sc-howto-findpd-tips-2 =
    სამთავრობო დადგენილებები, წიგნები და სტატიები აგრეთვე გამოსადეგია, მაგრამ,
...
sc-my-description =
    ...
    თუ საჭიროა, შეგიძლიათ უკვე შეტანილი წინადადებებიც წაშალოთ გვერდით უჯრის მონიშვნითა
    და ქვემოთ „შერჩეული წინადადებების წაშლაზე“ დაწკაპებით.
    გთხოვთ, მხოლოდ იმ შემთხვევაში ამოშალოთ, როცა აუცილებელია იქნება,
    მაგალითად, თუ აღმოაჩენთ, რომ საავტორო უფლებებით დაცული ყოფილა.
...
sc-submit-err-add-source = გთხოვთ მიუთითოთ წყარო.
...
citing-sentences-subheader-websites-explanation = შეგიძლიათ მიუთითოთ ვებსაიტი, მაგალითად „Common Voice - https://gonthuka3.swecha.org/“
citing-sentences-subheader-academic-reference = აკადემიური წყარო
citing-sentences-subheader-academic-reference-explanation = შეგიძლიათ დაურთოთ აკადემიური წყაროს სახითაც, მაგ. „Mozilla (2021) Common Voice. მისამართი https://gonthuka3.swecha.org/ (წვდომის თარიღი: 15 სექტემბერი 2021)“
...
citation-input-value = საიდანაა წინადადება აღებული
citation =
    .label = წყარო
...
new-sentence-rule-4 = გამართული მართლწერით
...
how-to-cite-explanation = თუ თავად შეადგინეთ, საკმარისია მიეწეროს <italicizedText>„საკუთარი ნამუშევარი“</italicizedText>. წყაროს დართვა იმიტომაა აუცილებელი, რომ შეგვეძლოს მასალის მოძიება, რათა გადავამოწმოთ, ნამდვილად საყოველთაო საკუთრებაშია თუ არა და საავტორო უფლებებით ხომ არ იკრძალება გამოყენება. უფრო ვრცლად წყაროს მითითების შესახებ იხილეთ ჩვენი <guidelinesLink>გზამკვლევის გვერდზე</guidelinesLink>.
...
sc-bulk-upload-instruction = ჩავლებით გადმოიტანეთ ან <uploadButton>დააჭირეთ ასატვირთად</uploadButton>
sc-bulk-upload-instruction-drop = ჩავლებით გადმოიტანეთ ასატვირთად
bulk-upload-additional-information = თუ გსურთ დამატებით რამე გვაცნობოთ ამ ფაილის შესახებ, გთხოვთ მოგვწეროთ <emailFragment>commonvoice@mozilla.com</emailFragment>
template-file-additional-information = თუ გსურთ დამატებით კიდევ რამე გვაცნობოთ ამ ფაილის შესახებ, რაც ნიმუშში ვერ მოხვდა, გთხოვთ მოგვწეროთ <emailFragment>commonvoice@mozilla.com</emailFragment>
...
select-file-mobile = ფაილის არჩევა ასატვირთად
accepted-files = ფაილის მისაღები სახეობაა: .tsv მხოლოდ
maximum-file-size = ფაილის მოცულობა არაუმეტეს: 25 მბაიტი
what-needs-to-be-in-file = რას უნდა შეიცავდეს ფაილი?
what-needs-to-be-in-file-explanation = გთხოვთ გადახედოთ <templateFileLink>ფაილის ნიმუშს</templateFileLink>. თქვენი წინადადებები უნდა წარმოადგენდეს საყოველთაო საკუთრებას (CC0-ლიცენზიით ან წინადადებების შემომტანის საკუთარ ნამუშევარს) და უნდა ეწეროს გასაგები ენით, გამართული მართლწერით, ადვილად რომ იკითხებოდეს. წარდგენილი წინადადებების ამოკითხვას მიახლოებით 10-15 წამი უნდა სჭირდებოდეს და არ უნდა შეიცავდეს ციფრებს, საკუთარ სახელებს ან რამე საგანგებო ნიშნებს.
upload-progress-text = ატვირთვა მიმდინარეობს...
