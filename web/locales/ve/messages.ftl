...
wall-of-text-second = Data nnzhi dzi shumiswaho nga khamphani khulwane, vhathu vhanzhi a vha koni u dzi swikelela. Ri vhona u nga zwi khou ita uri hu si vhe na mvelaphanḓa. Ndi ngazwo ro thoma Common Voice, thandela ine ya ḓo thusa uri u ḓivha ipfi zwi vhe zwa vhathu vhoṱhe na uri vha kone u zwi swikela.
...
voices-online = Maipfi kha vhuṱumani ha khomphyutha zwino
...
view-goals = Sedzani mvela phanḓa yaṋu nga u i vhambedza na tshiphikwa tsha thandela.
...
shortcut-rerecord-toggle-label = Dovhani ni rekhode
...
leaderboard-visibility =
    .label = U Vhonala ha Leaderboard
hidden = Dzumbea
visible = Vhonala
native-language =
    .label = Luambo lwa Ḓamuni
...
dashboard = Dashboard
build-profile = Itani Profaiḽi
avatar = Avatar
goals = Zwipikwa
settings = Setiṅi
edit-profile = Edithani Profaiḽi
profile-create-success = Zwo tshimbila, profile yo itiwa!
profile-close = Valani
...
faq-is-goal-assistant-q = Naa tshipikwa tsha Common Voice ndi u ita voice assistant?
...
faq-do-want-native-q = A si luambo lwanga lwa ḓamuni nahone ndi na kuambele kwanga, ni kha ḓi ṱoḓa ipfi ḽanga?
...
faq-why-different-speakers-q = Ndi ngani ni tshi ṱoḓa vhaambi vho fhambananaho vhanzhi kha luambo luthihi?
...
resource-nemo-info = <githubLink>NVIDIA NeMo</githubLink>™ ndi <docsLink>thulusi ya nnyi na nnyi</docsLink> ya vhaṱoḓulusi vhane vha khou ita maedza a AI a nyambedzano a maimo a nṱha.
...
resource-coqui-info = <coquiLink>Coqui</coquiLink> yo ḓinekedzela kha zwishumiswa zwa speech zwa thekhinolodzi zwa nnyi na nnyi. Thandela dzavho dzi katela dzindzhini dza STT na TTS dza u guda ho dzingindelaho.
community-playbook = Community Playbook
resource-playbook-info = <playbookLink>Wanani thuso</playbookLink> nga ha u shumisa Common Voice, u bva kha vhupo ha tsini u ya kha kushumisele kwa dataset, na nga ha nḓila ine na nga kwamana ngayo na vhadzulapo vha vhuponi haṋu.
data-other-librispeech-description = LibriSpeech ndi khophasi i ṱoḓaho u vha awara dza 1000 dza 16Khz dza u vhala tshipitzhi tsha Luisimane u bva kha dzibugu dza odio dza thandela ya LibriVox.
...
both-speak-and-listen = Vhuvhili Hazwo
...
contribution-misreadings-description-extended-list-2 = Hu khou shotha <strong>'s'</strong> mafheleloni a ipfi.
...
contribution-background-voices-title = Phoso ine ya khou Pfala
...
contribution-just-unsure-title = A ni na vhuṱanzi naa?
...
sc-languages-fetch-error = Ro balelwa u dzhia nyambo dzi re hone. A zwi konadzei u nikela zwa zwino. Ri humbela uri ni lingedze nga vhuya.
...
sc-howto-cite-item-1 = Ni nga katela na website, e.g "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Ni nga shumisa tshi taela tsha academic ni tshi ita dzi referentsi, sa tsumbo Harvard style "Mozilla (2021) Common Voice. Zwi wanala kha https://gonthuka3.swecha.org/ (Accessed: 15th Khumbvumedzi 2021)"
