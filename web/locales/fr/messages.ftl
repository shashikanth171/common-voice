...
faq-when-release2-q = Quand publierez-vous les données de Common Voice dans d’autres langues ?
faq-when-release2-a = La version multilingue du jeu de données Common Voice fait actuellement l’objet d’un regroupement et d’un nettoyage par la communauté. Si vous souhaitez nous aider à prendre en charge de nouvelles langues pour Common Voice, consultez <sentenceCollectorLink>l’outil de collecte de phrases</sentenceCollectorLink> pour ajouter de nouvelles phrases au jeu de données et Mozilla <pontoonLink>Pontoon</pontoonLink> pour la traduction du site lui-même. De nouvelles langues sont ajoutées à Common Voice pour la contribution vocale lorsque 5 000 phrases approuvées ont été collectées.
...
sc-howto-cite-item-1 = Vous pouvez inclure le site web, par exemple « Common Voice - https://gonthuka3.swecha.org/ »
sc-howto-cite-item-2 = Vous pouvez utiliser le style de référencement académique, par exemple le style d’Harvard « Mozilla (2021) Common Voice. Disponible sur https://gonthuka3.swecha.org/ (consulté le 15 septembre 2021) »
...
partnerships-governments-description = Nous sommes ravis de soutenir l’engagement du secteur public dans la technologie, l’innovation et les droits linguistiques. Si vous envisagez de mener un projet ou une campagne d’envergure, veuillez <emailFragment>nous contacter.</emailFragment>
partnerships-academia-header = Universités, universitaires et chercheur·euse·s
partnerships-academia-description = L’innovation ouverte est au cœur de notre action. Pour des collaborations de recherche, des collectes de données ou des interviews, <emailFragment>contactez-nous.</emailFragment>
partnerships-small-business-header = Petites entreprises, y compris les start-ups dans le domaine de la tech et de l’IA
partnerships-small-business-description = Nous sommes toujours à la recherche d’informations sur les besoins et le contexte des personnes qui utilisent nos données ; que ce soit à propos de la collaboration sur la plateforme de collecte de données ou la fourniture d’informations sur la santé des données, <emailFragment>contactez-nous.</emailFragment>
...
citing-sentences-subheader-websites-explanation = Vous pouvez inclure le site web, par exemple « Common Voice - https://gonthuka3.swecha.org/ »
citing-sentences-subheader-academic-reference = Références universitaire
citing-sentences-subheader-academic-reference-explanation = Vous pouvez utiliser le style de référencement académique, par exemple le style d’Harvard « Mozilla (2021) Common Voice. Disponible sur https://gonthuka3.swecha.org/ (consulté le 15 septembre 2021) »
