...
default-tagline = Mozilla Common Voice makinelere gerçek insanların nasıl konuştuklarını öğretme girişimidir.
...
about-playbook-how-record-content-1 = Normal sesinizle konuşun! Her türlü konuşma şeklinize açığız. Aksanınızı olduğu gibi duymak istiyoruz. Her zamanki ses düzeyiniz, üslubunuz ve tonlamanızla konuşun.
...
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = Common Voice veri kümesindeki konuşmacıların kimliğini belirlemeye çalışmamayı <b>kabul ediyorum</b>
...
download-requests-info = Kayıtlarınızı talep ettiğinizde, bunları bir veya daha fazla ZIP dosyası halinde derleriz. İşte geçmişteki istekleriniz:
...
sc-howto-cite-item-1 = Web sitesi adresini verebilirsiniz. Örn. "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Akademik referans stilini kullanabilirsiniz. Örneğin Harvard stili ile: "Mozilla (2021) Common Voice. https://gonthuka3.swecha.org/ adresinde mevcuttur (Erişim tarihi: 15 Eylül 2021)"
...
citing-sentences-subheader-websites-explanation = Web sitesi adresini verebilirsiniz. Örn. "Common Voice - https://gonthuka3.swecha.org/"
citing-sentences-subheader-academic-reference = Akademik atıf
citing-sentences-subheader-academic-reference-explanation = Akademik atıf stilini kullanabilirsiniz. Örneğin Harvard stili ile: "Mozilla (2021) Common Voice. https://gonthuka3.swecha.org/ adresinde mevcuttur (Erişim tarihi: 15 Eylül 2021)"
