...
faq-why-important-a =
    Η ομιλία είναι συχνά ο πιο φυσικός τρόπος επικοινωνίας μεταξύ μας και οι τεχνολογίες φωνής φέρνουν αυτήν την ευκολία στους υπολογιστές και τις κινητές συσκευές μας. Θέλουμε να υποστηρίξουμε τους προγραμματιστές ώστε να δημιουργήσουν εκπληκτικές εφαρμογές αναγνώρισης φωνής, όπως εφαρμογές μετάφρασης σε πραγματικό χρόνο και ψηφιακούς βοηθούς με λειτουργίες φωνής. Αλλά αυτήν τη στιγμή, τα περισσότερα φωνητικά δεδομένα που απαιτούνται για την κατασκευή τέτοιων εφαρμογών είναι ακριβά και ιδιωτικά. Ελπίζουμε ότι το σύνολο δεδομένων του Common Voice θα δώσει στους προγραμματιστές ό,τι χρειάζονται για να καινοτομήσουν και να κάνουν την τεχνολογία ομιλίας διαθέσιμη στη δική τους γλώσσα.
...
faq-how-calc-hours-a = Υπολογίζουμε τις ώρες εκτιμώντας το μέσο μήκος κάθε ηχογράφησης και πολλαπλασιάζοντας τον αριθμό αυτό με τον συνολικό αριθμό ηχογραφήσεων σε όλες τις γλώσσες.
...
faq-where-src-from-2-a =
    ...
    Μπορείτε να δείτε τις προτάσεις του πηγαίου κειμένου σε αυτόν τον <githubLink>φάκελο του GitHub</githubLink>.
...
report-ask = Τι ζητήματα αντιμετωπίζετε με αυτήν την πρόταση;
...
sc-howto-cite-title = Τρόποι παραπομπής
sc-howto-cite-pre-1 = Είναι σημαντικό να αναφέρετε πού βρήκατε τη δημόσια άδεια για να αποφύγετε τη λογοκλοπή, καθώς και <copyrightIssuesLink>ζητήματα πνευματικών δικαιωμάτων</copyrightIssuesLink>. Ακολουθούν μερικοί τρόποι με τους οποίους μπορείτε να κάνετε παραπομπή του έργου.
sc-howto-cite-item-1 = Μπορείτε να συμπεριλάβετε τον ιστότοπο, π.χ. «Common Voice - https://gonthuka3.swecha.org/»
sc-howto-cite-item-2 = Μπορείτε να χρησιμοποιήσετε αναφορά ακαδημαϊκού τύπου, π.χ. στυλ του Harvard «Mozilla (2021) Common Voice. Διαθέσιμο στο https://gonthuka3.swecha.org/ (Ανακτήθηκε στις 15 Σεπτεμβρίου 2021)»
...
citing-sentences-subheader-websites-explanation = Μπορείτε να συμπεριλάβετε τον ιστότοπο, π.χ. «Common Voice - https://gonthuka3.swecha.org/»
citing-sentences-subheader-academic-reference = Ακαδημαϊκή αναφορά
citing-sentences-subheader-academic-reference-explanation = Μπορείτε να χρησιμοποιήσετε αναφορά ακαδημαϊκού τύπου, π.χ. το στυλ του Harvard: «Mozilla (2021) Common Voice. Διαθέσιμο στο https://gonthuka3.swecha.org/ (Ανακτήθηκε στις 15 Σεπτεμβρίου 2021)»
...
bulk-upload-failed-toast = Η μεταφόρτωση απέτυχε, δοκιμάστε ξανά.
bulk-submission-success-header = Σας ευχαριστούμε για τη μαζική υποβολή σας!
bulk-submission-success-subheader = Βοηθάτε το Common Voice να πετύχει τους ημερήσιους στόχους προτάσεων!
upload-more-btn-text = Μεταφόρτωση περισσότερων προτάσεων;
file-invalid-type = Μη έγκυρο αρχείο
