...
sc-howto-cite-item-1 = 您可以包含網址，例如「Common Voice - https://gonthuka3.swecha.org/」
sc-howto-cite-item-2 = 您也可以使用學術參考文獻格式，例如哈佛格式「Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)」
...
citing-sentences-subheader-websites-explanation = 您可以包含網址，例如「Common Voice - https://gonthuka3.swecha.org/」
citing-sentences-subheader-academic-reference = 學術參考資料
citing-sentences-subheader-academic-reference-explanation = 您也可以使用學術參考文獻格式，例如哈佛格式「Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)」
...
new-sentence-rule-4 = 正確使用標點符號（句尾不需句號）
new-sentence-rule-5 = 不包含英數字（數字可改為國字大寫）
