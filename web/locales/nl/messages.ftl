...
voices-online = Stemmen op dit moment online
todays-progress = Voortgang van vandaag
...
data-download-singleword-callout-v2 = Dit is een gebruiksgebaseerd segment dat gegevens bevat om herkenning van gesproken cijfers en detectie van ja/nee mogelijk te maken.
...
community-playbook = Gemeenschapsdraaiboek
resource-playbook-info = <playbookLink>Ontdek nuttige handleidingen</playbookLink> over het gehele Common Voice-traject, van lokalisatie tot gebruik van de dataset, evenals hoe u contact kunt maken met onze gemeenschap.
...
download-q = Wilt u uw gegevens downloaden?
download-info = Vertel ons wat u wilt downloaden:
download-profile-title = Profiel
download-profile-info = Bevat e-mailadres, gebruikersnaam en demografische gegevens
download-profile-size = Een paar bytes
...
download-request = Download aanvragen
download-requests = Eerdere downloadverzoeken
download-requests-info = Wanneer u uw opnamen opvraagt, compileren wij deze in één of meerdere ZIP-bestanden. Dit zijn uw eerdere verzoeken:
download-request-button = Downloaden
download-request-title = { $created }
download-request-description = { $clipCount } spraakfragmenten, totale archiefgrootte { $size }. Verloopt { $expires }.
download-request-archive-single = Enkel ZIP-bestand met
download-request-archive-multiple = Gesplitst over { $archiveCount } ZIP-bestanden met
download-request-assembling-description = Uw bestanden worden samengesteld. Kom later terug.
download-request-refresh-button = Vernieuwen
download-request-modal-title = Downloadkoppelingen
download-request-modal-description = Hier zijn de koppelingen om uw ZIP-bestanden te downloaden.
...
demo-get-started = Laten we beginnen
demo-welcome = Welkom bij Common Voice
demo-welcome-subheader = Interesse om meer te leren en bij te dragen aan het project?

## Demo Datasets

demo-language-select-card-header = Common Voice is de grootste openbare meertalige spraakgegevensset ter wereld.
demo-language-select-card-body = Dankzij bijdragen van meer dan 259.000 mensen in meer dan 50 talen, worden deze gegevens gebruikt om spraakgestuurde toepassingen te trainen om beter op de menselijke stem te reageren.
card-button-next = Volgende
card-button-back = Terug
demo-language-select-label = Door talen bladeren
demo-eofy-header = Eindejaarsuitgave 2019
demo-eofy-sub_header = Spraakgegevensset, klaar om te downloaden
demo-account = Account

## Demo Account

demo-account-card-header = Een account is niet nodig om bij te dragen, hoewel het wel nuttig is.
demo-account-card-body = Rechts schetsen we de voordelen en verduidelijken we welke informatie we openbaar maken. Gebruik de onderstaande koppelingen om op uw eigen apparaat aan de slag te gaan met een Common Voice-account.
demo-account-enter-email =
    .label = Voer een e-mailadres in om een inschrijfkoppeling te verzenden
demo-account-sign-up = Inschrijfkoppeling verzenden
