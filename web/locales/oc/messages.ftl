...
banner-error-slow-1 = Mos sap mau, Common Voice trigue a cargar-se, gràcies per interès.
banner-error-slow-2 = Era plataforma va fòrça cargada darrèrament, investigam es problèmes e demoram solucionar-les lèu.
banner-error-slow-link = Estat deth projècte
error-something-went-wrong = I a agut un problèma
...
about-playbook-how-access-dataset-content-2 = Se cercatz estruments entà crear modèls RAP, vos podetz connectar damb d’autes persones dera comunitat <discourseLink>en Discourse</discourseLink>.

## How are decisions made

about-playbook-how-project-governance = Com se prenen es decisions deth projècte?
about-playbook-how-project-governance-content-1 = Mozilla Common Voice ei possible mercés a ua comunitat diuèrsa d'activistes, lingüistes, scientifics de donades, academics e enginhèrs de logiciau de tot eth mon. Eth projècte ei gestionat pera Fondacion Mozilla.
about-playbook-how-project-governance-content-2 = Era nòsta governança se base enes pilars de:
about-playbook-how-project-governance-content-3 = Privadança, seguretat e transparéncia.
about-playbook-how-project-governance-content-4 = Participacion comunitària e presa de decisions.
...
localization-explanation = Procès de traduccion e adaptacion deth contengut en d’autes lengües.
sentence-collection = Recuelhuda de frases
sentence-collection-explanation = Recuélher frases deth domeni public o escriuer-ne de naues entath domeni public.
hours-recorded-explanation = Recompde des ores d’enregistrament de votz que s'an arrecuelhut enquia ara.
hours-validated-explanation = Recompde des ores d’enregistrament de votz que s'an validat. Ua frasa se considère validada quan dus de tres usatgèrs vòten «Òc». Aguestes ores compden entar objectiu generau deth projècte de 10.000 ores.
...
contribute-more = Prèst/a entà hèr-ne { $count } mès?
...
sc-howto-cite-item-1 = Podetz includir eth lòc web, per exemple, «Common Voice - https://gonthuka3.swecha.org/»
sc-howto-cite-item-2 = Podetz utilizar un estil de referéncia academica. P. ex., er estil de Harvard «Mozilla (2021) Common Voice. Disponible en https://gonthuka3.swecha.org/ (Consultat: 15 de seteme de 2021)»
