...
wall-of-text-first = Sprog er naturligt, sprog er menneskeligt. Derfor er vi glade for at skabe nyttig stemmeteknologi for vores maskiner. Men for at skabe talesystemer behøver udviklerne en ekstrem stor mængde stemmedata.
wall-of-text-second = Det meste af det data som anvendes af store virksomheder er ikke tilgængeligt for de fleste mennesker. Vi synes det kvæler innovation. Så vi har lanceret Common Voice, et projekt som hjælper med at gøre talegenkendelse åbent og tilgængeligt for alle.
...
clips-you-recorded = Optagelser, du har optaget
clips-you-validated = Optagelser, du har valideret
...
recorded-clips = Optagelser
validated-clips = Validerede optagelser
...
pro-difficulty = Pro
lose-goal-progress-warning = Ved at redigere dit mål, kan du miste dit eksisterende fremskridt.
...
sc-howto-cite-item-1 = Du kan inkludere webstedet, f.eks. "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Du kan bruge akademisk referencestil, fx Harvard-stil: "Mozilla (2021) Common Voice. Tilgængelig på https://gonthuka3.swecha.org/ (Besøgt: 15. september 2021)"
