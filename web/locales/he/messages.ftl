...
shortcut-submit = מקש Enter
shortcut-submit-label = שליחת מקטעים
...
change-email-setings = שנו את כתובת הדוא״ל שלכם דרך ההגדרות תחת זהות כניסה

## FAQ

faq-title = תשובות לשאלות נפוצות
faq-what-cv-q = מה זה Common Voice?
faq-what-cv-a = טכנולוגיית זיהוי קולי מהווה מהפכה בדרך בה אנו מקיימים אינטראקציה עם מכונות, אך המערכות הזמינות כיום הן יקרות וקנייניות. Common Voice הוא חלק מהיוזמה של Mozilla שמטרתה להפוך את טכנולוגיות הזיהוי הקולי לטובות ונגישות יותר לכולם. Common Voice הוא מסד נתונים גלובלי ומסיבי של קולות שנתרמו המאפשר לכל אחת ואחד לאמן במהירות ובקלות יישומים מופעלי-קול כמעט בכל שפה.
faq-what-cv-a-2 =
    טכנולוגיית זיהוי קולי משנה לחלוטין את הדרך בה אנו מתקשרים עם מכונות, אך המערכות שזמינות היום הן יקרות וקנייניות. Common Voice מבית Mozilla היא יזמה לשפר את טכנולוגיות הזיהוי הקולי ולהנגיש אותן לכולם. Common Voice הוא מסד נתונים גלובלי ענק של קולות שנתרמו שמאפשר לכולם לאמן יישומים מונחי קול במהירות ובקלות בכמעט כל השפות.
    
    אנחנו לא אוספים דגימות קול רק בשפות נפוצות אלא גם בכאלו עם אוכלוסיה קטנה של דוברים. פרסומו של מערך נתונים הכולל מגוון של קולות יאפשר למתכנתים, יזמים וקהילות לגשר על הפער הזה בכוחות עצמם.
...
faq-why-important-a =
    ...
    כדי להפוך את הזיהוי הקולי להיות אפילו יותר אוניברסלי, לצד דגימות קוליות בשפות המדוברות באופן נרחב, אנו אוספים גם דגימות בשפות עם אוכלוסייה קטנה יותר של דוברים, שלעיתים אינן זוכות להתייחסות הולם אצל שירותי זיהוי דיבור מסחריים. פרסומו של מערך נתונים הכולל מגוון של קולות יאפשר למתכנתים, יזמים ולקהילות שמות לגשר על הפער הזה בכוחות עצמם.
faq-how-get-q = איך ניתן לקבל את הנתונים מ־Common Voice?
faq-how-get-a = מערך הנתונים של Common Voice זמין להורדה תחת הרישיון <licenseLink>CC0</licenseLink> <datasetLink>בדף מערכי הנתונים שלנו</datasetLink>. ניתן גם להוריד מספר מערכי נתונים אחרים הזמינים לציבור מאותו הדף.
...
faq-is-goal-assistant-a = המטרה של מערך הנתונים של Common Voice היא לאפשר לכל אחד בעולם לבנות זיהוי דיבור, זיהוי דובר, או כל סוג אחר של יישום הדורש נתונים קוליים. עוזר קולי הוא רק יישום אחד מיני רבים שתוכלו לבנות באמצעות מערך הנתונים.
...
faq-why-not-ask-read-a = כדי להפוך את מערך הנתונים של Common Voice לשימושי ככל האפשר החלטנו לאפשר רק טקסט מקור הזמין תחת הרישיון Creative Commons (CC0). שימוש ברישיון CC0 מתוקנן פירושו שקשה יותר למצוא ולאסוף טקסט מקור, אך בו בזמן זה מאפשר לכל אחד להשתמש בנתוני הקול שהתקבלו ללא הגבלות שימוש או אישור מ־Mozilla. בסופו של דבר, אנחנו רוצים להפוך את מערך הנתונים בשפות שונות לשימושי ככל האפשר לכולם, כולל חוקרים, אוניברסיטאות, חברות הזנק, ממשלות, ארגונים למטרות חברתיות, וחובבים.
...
faq-how-privacy-a = אנו מסירים ממקטעי הקול כל מידע המאפשר זיהוי אישי. כאשר תורם מספק נתונים דמוגרפיים באמצעות הפרופיל שלהם, מידע זה אינו משוייך לקטעי הקול שלהם לפני שהוא נארז להורדה במערך הנתונים והוא אף פעם אינו מוצג לציבור בדף הפרופיל שלהם.
faq-what-determine-identity-q = מה זה אומר שאסור לי ״לזהות את הדוברים״ במערך הנתונים של Common Voice?
faq-what-determine-identity-a =
    מערך הנתונים של Common Voice הוא משאב פתוח וזמין לציבור שניתן להשתמש בו כדי לאמן מגוון רחב של יישומים מותאמי דיבור. כדי להגן על הפרטיות של התורמים שלנו, אנו מבקשים מכל מי שמוריד את מערך הנתונים של Common Voice לכבד את פרטיותם של התורמים.
    
    הסרנו כל מידע אישי מקטעי הקול. כאשר אתם מורידים את מערך הנתונים, הנכם מביעים את הסכמתכם לא לנסות לקבוע את זהותו של אף תורם. כלומר, אסור לכם לנסות לקשר מידע במערך הנתונים למידע האישי של תורם. עם זאת, באפשרותכם להשתמש במערך הנתונים כדי לאמן זיהוי דיבור, זיהוי דובר או יישומים אחרים, למשל, באמצעות קישור מידע המצוי במערך הנתונים למידע אחר שגם הוא כבר נמצא במערך הנתונים.
...
datasets-heading = מערכי נתונים
datasets-headline = אנו בונים מערך נתונים קולי שהוא פתוח ורב-לשוני, בו כל אחת ואחד יוכלו להשתמש לפיתוח יישומים המופעלים בדיבור.
datasets-positioning =
    אנו מאמינים שמערכי נתונים קוליים גדולים הזמינים באופן פומבי ייטפחו חדשנות ותחרות מסחרית בריאה בתחום טכנולוגיית זיהוי הקול על בסיס לימוד מכונה.
...
download-dataset-tag = בחרו את השפה הרצויה והגרסה של מערך הנתונים שברצונכם להוריד.
...
contribution-misreadings-description = בעת האזנה, בדקו היטב שמה שהוקלט הוא בדיוק מה שנכתב; יש לדחות במקרה וקיימות אפילו שגיאות קלות. <br />טעויות נפוצות מאוד כוללות:
contribution-misreadings-description-extended-list-1 = השמטה של תחילית או מילה קצרה, למשל ו' החיבור, ה' הידיעה או מילה קצרה כמו "אם".
contribution-misreadings-description-extended-list-2 = בלבול במין בשם המספר, למשל קריאה שגויה  <strong>"שלושה בנות"</strong>  במקום <strong>"שלוש בנות"</strong>.
...
citing-sentences-subheader-websites-explanation = ניתן לכלול את הכתובת, למשל "קול משותף - https://gonthuka3.swecha.org/"
citing-sentences-subheader-academic-reference = ציטוט למקור אקדמי
citing-sentences-subheader-academic-reference-explanation = ניתן להשתמש בסגנון הפניה אקדמי, למשל בסגנון הרווארד "Mozilla (2021) Common Voice. זמין בכתובת https://gonthuka3.swecha.org/ (גישה: 15 בספטמבר 2021)"
...
new-sentence-rule-4 = שימוש באיות ובסימני פיסוק נכונים
new-sentence-rule-5 = ללא מספרים ותווים מיוחדים
