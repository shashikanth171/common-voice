...
join-newsletter = Prípadne sa pripojte na odber noviniek o projekte.
...
download-recordings-size = Zvyčajne megabajty
download-recordings-unavailable = Nemôžete požiadať o svoje nahrávky, kým prebieha iná žiadosť.
download-recently-requested = O nové stiahnutie svojich nahrávok môžete požiadať každých { $days } dní.
download-size = Veľkosť
download-selected = Zvolené
download-start = Stiahnuť údaje profilu
download-request = Vyžiadať nahrávky
download-requests = Žiadosti o stiahnutie predchádzajúcich nahrávok
...
download-request-modal-title = Odkazy na stiahnutie
download-request-modal-description = Tu sú odkazy na stiahnutie súborov ZIP.
...
contribution-misreadings-example-2-title = Obrie dinosaur z triasu.
contribution-misreadings-example-2-explanation = [Mali by to byť „dinosaury“]
contribution-misreadings-example-3-title = Obrie dinosaury z tria-.
contribution-misreadings-example-3-explanation = [Záznam je prerušený pred koncom posledného slova]
contribution-misreadings-example-4-title = Obrie dinosaury z triasu. Áno.
contribution-misreadings-example-4-explanation = [Bolo zaznamenané viac, než je požadovaný text]
contribution-misreadings-example-5-title = Ideme von na kávu.
contribution-misreadings-example-6-title = My ideme von na kávu.
contribution-misreadings-example-6-explanation = [Malo by byť „Ideme von...“]
contribution-misreadings-example-7-title = Ideme von na 1 kávu.
contribution-misreadings-example-7-explanation = [V pôvodnom texte nie je "1"]
...
contribution-varying-pronunciations-example-2-title = Jeho ruka bola zdvihnutá.
contribution-varying-pronunciations-example-2-explanation = [„zdvihnutá“ sa v angličtine vždy vyslovuje ako jedna slabika, nie ako dve.
...
contribution-background-noise-example-1-fixed-title = <strong>[zasmrkanie]</strong> Obrie dinosaury z <strong>[zakašľanie]</strong> triasu.
contribution-background-noise-example-2-fixed-title = Obrovský dino <strong>[zakašľanie]</strong> z triasu.
...
sc-howto-cite-item-1 = Môžete zahrnúť webovú stránku, napr. „Common Voice – https://gonthuka3.swecha.org/“
sc-howto-cite-item-2 = Môžete použiť akademický štýl odkazovania, napr. Harvardský štýl „Mozilla (2021) Common Voice. Dostupné na https://gonthuka3.swecha.org/ (Prístup: 15. septembra 2021)“
...
citing-sentences-subheader-websites-explanation = Môžete zahrnúť webovú stránku, napr. „Common Voice – https://gonthuka3.swecha.org/“
citing-sentences-subheader-academic-reference = Akademická referencia
citing-sentences-subheader-academic-reference-explanation = Môžete použiť akademický štýl odkazovania, napr. Harvardský štýl „Mozilla (2021) Common Voice. Dostupné na https://gonthuka3.swecha.org/ (Prístup: 15. septembra 2021)“
