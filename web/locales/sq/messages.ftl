...
sentence-collection-explanation = Grumbullim frazash nga përkatësia publike, ose shkrimi i të tillash të reja për nën përkatësinë publike.
...
report-ask = Ç’probleme po hasni me këtë frazë?
report-offensive-language = Gjuhë fyese
report-offensive-language-detail = Fraza ka gjuhë shpërfillëse ose fyese.
report-grammar-or-spelling = Gabim gramatikor / shkrimi
report-grammar-or-spelling-detail = Fraza ka një gabim gramatikor ose shkrimi.
...
sc-howto-cite-item-1 = Mund të përfshinit sajtin, p.sh., “Common Voice - https://gonthuka3.swecha.org/”
sc-howto-cite-item-2 = Mund të përdorni stil akademik referencash, p.sh., stilin e Harvardit "Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)"
...
partnerships-foundations-description = Punojmë me fondacione, shoqërinë civile dhe partnerë të bashkësisë për ta bërë Internetin një vend më të shëndetshëm, me vëmendje të veçantë mbi Afrikën Lindore. Mësoni më tepër mbi <programmaticWork>punën tonë programatike.</programmaticWork>
partnerships-governments-header = Qeveri
partnerships-governments-description = Jemi të ngazëllyer që mbështetim angazhimin e sektorit publik në teknologji, risi dhe të drejta gjuhësore. Nëse keni në plan të organizoni një projekt apo fushatë të madhe, ju lutemi, <emailFragment>na thoni.</emailFragment>
...
citing-sentences-subheader-websites-explanation = Mund të përfshinit sajtin, p.sh., “Common Voice - https://gonthuka3.swecha.org/”
citing-sentences-subheader-academic-reference = Referencë Akademike
citing-sentences-subheader-academic-reference-explanation = Mund të përdorni stil akademik referencash, p.sh., stilin e Harvardit “Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)”
