...
benefits = Bantàgios
rich-data = Arrichi is datos chi imbias frunende informatziones demogràficas anònimas. Custa informatzione at a èssere anonimizada in antis de dda publicare.
...
keep-track = Sighi is progressos e is mètricas tuas in prus limbas.
...
status-title = Istadu generale de su progetu: càstia fintzas a ue semus arribados!
...
status-goal = Obietivos imbenientes: { $goal }
english = Inglesu
...
download-title = S'iscarrigamentu at cumintzadu.
...
contribution-varying-pronunciations-description = Pensa·bi unu pagu in antis de refudare una registratzione ca su leghidore at pronuntziadu male unu faeddu, at postu s'atzentu in su tretu isballiadu o paret chi apat ignoradu unu puntu interrogativu. Ddoe sunt pronùntzias medas impreadas in su mundu, e medas de cussa mancari non ddas as mai intesas in sa comunidade locale tua. Chirca de tènnere unu pagu de elastitzidade e de aprètziu pro is chi faeddant in manera diferente dae sa tua.
...
citing-sentences-subheader-websites-explanation = Dias pòdere inclùdere su situ web, pro esempru «Common Voice - https://gonthuka3.swecha.org/»
