...
yes-receive-emails = 네, 이메일을 보내 주세요. Common Voice 프로젝트에 대해 계속 알고 싶습니다.
...
wall-of-text-first = 목소리는 자연적이고 사람을 나타냅니다. 그래서 우리는 기계를 위한 사용할 만한 음성 기술을 만들고자 하게 되었습니다. 하지만 음성 시스템을 만들기 위해서 개발자는 매우 많은 양의 데이터가 필요합니다.
...
keep-track = 여러 언어에 걸친 진행 상황과 측정 내용을 추적 하세요.
compare-progress = 내 진행 상황이 전세계의 다른 기여자들과 어떻게 다른지 비교해 보세요.
view-goals = 개인과 프로젝트의 목표에 대한 진행 상황을 확인해 보세요.
...
demographic-deidentified-clarity-2 = 선택적으로 제출 된 인구 통계 데이터 (예 : 연령, 성별, 언어 및 악센트)는 프로필에 공개되지 않으며 데이터 세트의 계정에 연결되지 않습니다. 보다 정확한 분석을 위해 개별 오디오 클립이 인구 통계 데이터와 연결됩니다. 예를 들어, 연구원은 특정 인구 통계 세그먼트에 대한 훈련 모델을 대상으로 할 수 있습니다.
...
status-title = 전반적인 프로젝트 현황: 얼마나 발전했는지 확인해 보세요!
status-contribute = 목소리 기여하기
status-hours =
    { $hours ->
       *[other] { $hours } 시간이 지금까지 확인되었습니다!
    }
# Variables:
# $goal - number of hours representing the next goal
status-goal = 다음 목표: { $goal }
english = 영어
...
faq-why-mission-a = Mozilla는 모든 사람에게 웹을 개방하고 접근 가능하게 만드는데 전념하고 있습니다. 그러기 위해서 우리는 Common Voice와 같은 프로젝트를 통해 웹 제작자들에게 힘을 실어 주어야 합니다. 음성 기술이 틈새 시장을 넘어 확산됨에 따라 우리는 음성 기술이 모든 사용자에게 동등하게 제공되어야 한다고 생각합니다. 이 말은 음성 기술을 만들고 테스트 할 때 더 많은 언어와 다양한 억양, 인구를 조사해야 함을 의미합니다. Common Voice는 모든 사람들이 사용할 수 있는 공공 자원이고 Mozilla팀과 전 세계의 개발자들이 이미 제품을 만드는데 사용하고 있습니다.
...
faq-what-determine-identity-a =
    Common Voice 데이터 세트는 음성 지원 어플리케이션을 훈련할 수 있는 공개된 자원입니다. 기여자의 보안을 지키기 위해 Common Voice 데이터 세트를 다운로드하는 모든 사람들에게 기여자의 개인정보를 존중하도록 요청합니다.
    
    데이터 세트의 모든 음성 클립은 개인 식별 정보가 삭제된 상태로 제공됩니다. 데이터 세트를 다운로드 할 때 기여자의 신원을 확인하지 않을 것을 동의합니다. 즉, 데이터 세트의 정보와 기여자의 개인 정보를 링크할 수 없다는 것을 의미합니다. 그러나 데이터 세트의 정보와 이미 데이터 세트 안에 있는 다른 정보를 서로 연결해서 데이터 세트를 음성 인식이나 화자 인식, 다른 어플리케이션을 훈련하는데 사용할 수 있습니다.
...
about-listen-queue-text = 음성 클립은 듣기가 가능하도록 준비하는 작업 대기열에 들어갑니다.
about-listen = 듣기
about-listen-text = 사용자는 기부된  클립의 정확성을 검증하여 화자가 문장을 올바르게 읽었는지 확인합니다.
about-is-it-valid = 클립이 유효합니까?
about-is-it-valid-text = 음성 클립은 사용자가 찬성에 투표를하면 "유효"로 표시됩니다.
about-yes-votes = ≥ 2 찬성표
about-yes-votes-text = 음성 클립은 서로 다른 두 사람이 승인해야 Common Voice 데이터 세트에 들어갑니다.
...
sc-howto-cite-item-1 = 웹사이트를 포함할 수 있습니다. 예를 들어 "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = 학술적 참조 스타일을 사용할 수 있습니다. 예를 들어 Harvard 스타일 "Mozilla(2021) Common Voice. https://gonthuka3.swecha.org/ 에서 사용 가능(접근: 2021년 9월 15일)"
...
citing-sentences-subheader-websites-explanation = 웹사이트를 포함할 수 있습니다. 예를 들어 "Common Voice - https://gonthuka3.swecha.org/"
