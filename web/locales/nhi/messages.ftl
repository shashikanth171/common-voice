...
confirm-no-identify = <b>timotlahtolmaca</b>que amo ticyehyecos tictemos inexican tlahtuhuaneh ichin base de tlanahuatil de Common Voice
confirm-join-mailing-list = nicniqui nimonilos ichi lista de correos de Common Voice
download-language = timulti{ $language }
whats-inside = ¿tlenon catqui ichin base de tlanahuatil de Common Voice?
want-dataset-update = ¿ticniqui ticsilis tlanahuatil ica yancoic tlanahuatil huan actualizaciones de base de tlanahuatil Common Voice? ximuihcoilo ichin toboletin
subscribe = ximuihcoilo
...
listen-instruction = { $actionType }<playIcon></playIcon>¿ oquihtohqueh tlahtol coali?
...
contribution-misreadings-example-7-explanation = [amo catqui ´a´ichin tlahcuilol tlen milahuac]
contribution-misreadings-example-8-title = serahcuilin upanuc ica isiuhcayotl
...
contribution-varying-pronunciations-example-1-title = ichin i tzonticon cuica se cuatilmahtl
...
contribution-background-noise-title = tlacalania ic tlahtic
...
contribution-background-noise-example-1-fixed-title = <strong>[ahcuixuhua]</strong> dinosaurios huehueyitiqueh de <strong>[tlatlasistl</strong> yeheyi
...
sc-howto-cite-item-1 = huilis tic tlalilisqueh sitio web,queme nicancah Common Voice-https://gonthuka3.swecha.org/
sc-howto-cite-item-2 = huilis tiquicuis referencia academica. musequihto  quenin Harvard  ¨Mozilla (2021) Common Voice. catqui https://gonthuka3.swecha.org/  (xiquita: 15 de septiembre de 2021)¨
