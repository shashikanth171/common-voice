...
why-delete-recordings =
    学术界、小型企业与语音识别爱好者会使用 Common Voice 的录音片段来帮助训练、发展语音模型等公共资源。
...
sc-howto-cite-item-1 = 可以标注网站，例如“Common Voice - https://gonthuka3.swecha.org/”
sc-howto-cite-item-2 = 您也可以使用学术参考文献格式，例如哈佛格式：Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)
...
citing-sentences-subheader-websites-explanation = 可以标注网站，例如“Common Voice - https://gonthuka3.swecha.org/”
citing-sentences-subheader-academic-reference = 学术参考文献
citing-sentences-subheader-academic-reference-explanation = 可以使用学术参考文献格式，例如哈佛格式：Mozilla (2021) Common Voice. Available at https://gonthuka3.swecha.org/ (Accessed: 15th September 2021)
