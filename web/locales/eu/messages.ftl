...
faq-when-release2-a = Common Voice datu-artxibategiaren bertsio eleaniztuna taldekatzen eta garbitzen ari da komunitatea. Common Voice-rako hizkuntza berriak onartzen lagundu nahi badiguzu, kontsultatu <sentenceCollectorLink>esaldiak biltzeko tresna</sentenceCollectorLink> datu multzoari eta Mozillari esaldi berriak gehitzeko eta <pontoonLink>Pontoon</pontoonLink> webgunea bera itzultzeko. Hizkuntza berriak gehituko zaizkio Common Voice-ri, ahotsa emateko, onetsitako 5.000 esaldi biltzean.
faq-why-mission-q = Zergatik da Common Voice  Mozilla misioaren parte?
faq-why-mission-a = Mozillaren egitekoa, weba guztiontzat irekia eta eskuragarri mantentzea da. Horretarako, web-sortzaileak Common Voice bezalako proiektuetan ahaldundu behar ditugu. Ahots teknologiek beraien merkatu-nitxotik haratagoko aplikazioetara hedatzen diren heinean, uste dugu erabiltzaile guztiak berdin zerbitzatu behar dituztela. Horregatik saiatzen gara hizkuntza gehiagotara zabaltzen eta ahots teknologien sortzea eta proba, hizkera eta talde demografiko ezberdinetara moldatzen. Common Voice guztiontzat eskuragarri dagoen baliabide publiko bat da eta munduan zehar dauden Mozilla taldeak eta garatzaileak dagoeneko beraien proiektuetarako erabiltzen ari dira.
...
faq-why-different-speakers-a =
    ...
    Horregatik nahi dugu aniztasuna gure ahotsen datu-sortan!
...
faq-why-10k-hours-a = Ordu kopuru hau gutxi gorabehera ekoizpeneko speech-to-text sistema bat trebatzeko behar dena da.
...
faq-why-not-ask-read-a = Common Voicen datu-sorta ahalik erabilgarriena egiteko, Creative Commons (CC0) lizentzia duten testuak soilik onartzea erabaki dugu. CC0 estandarra erabiltzeak zaildu egiten du jatorrizko testuak biltzea, baina edonork erabili ahal izateko aukera ematen du, inolako erabilera edo egiletza aitortza murrizketarik gabe. Lortu nahi duguna da datu-sorta eleanitza guztientzat ahalik erabilgarriena izatea, bai ikertzaileentzat, unibertsitateentzat, startup-entzat, gobernuentzat, helburu sozialak dituzten erakundeentzat, baita interesa duen edonorentzat ere.
...
contact-form-message =
    .label = Mezua
contact-required = *beharrezkoa

## Request Language Modal

request-language-title = Hizkuntza-eskaera
...
sc-footer-translate = Itzuli web-orri hau
...
sc-home-review-text = Lagun gaitzazu esaldien zuzentasuna gidalerroen arabera berrikusten.
...
sc-howto-cite-item-1 = Webgunea gehi zenezake. Adibidez: "Common Voice - https://gonthuka3.swecha.org/eu"
...
partnerships-header-text = Common Voice aurrera ateratzea zaila da! Ezingo genuke bakarrik egin. Babestu nahi gaituzu? Zure berri izateko irrikitan gaude.
...
citing-sentences-subheader-websites-explanation = Webgunea gehi zenezake. Adibidez: "Common Voice - https://gonthuka3.swecha.org/eu"
