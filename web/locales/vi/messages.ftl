...
wall-of-text-first = Giọng nói là tự nhiên, giọng nói là con người. Đó là lý do tại sao chúng tôi hứng thú với việc tạo ra công nghệ giọng nói có thể sử dụng được cho các phần mềm. Nhưng để tạo ra hệ thống này thì các nhà phát triển cần một lượng dữ liệu giọng nói rất lớn.
wall-of-text-second = Phần lớn các dữ liệu được sử dụng bởi các công ty lớn thì không có sẵn cho đa số mọi người. Chúng tôi nghĩ rằng điều này làm cản trở sự sáng tạo. Vì vậy chúng tôi ra mắt dự án Common Voice, một dự án giúp mọi người tiếp cận được công nghệ nhận dạng giọng nói.
...
benefits = Lợi ích
rich-data = Làm cho dữ liệu được gửi của bạn phong phú nhất có thể bằng cách cung cấp một số dữ liệu nhân khẩu học ẩn danh. Chúng tôi hủy nhận dạng tất cả dữ liệu nhân khẩu học trước khi công khai.
...
shortcut-play-toggle-label = Phát/Dừng
...
status-title = Tổng trạng thái của dự án: xem chúng tôi đã đi được bao xa!
status-contribute = Đóng góp giọng nói của bạn
status-hours =
    { $hours ->
       *[other] { $hours } tổng số giờ đã xác thực!
    }
# Variables:
...
download-helpus = Giúp chúng tôi xây dựng một cộng đồng xung quanh công nghệ giọng nói, giữ liên lạc qua email.
download-form-email =
    .label = Nhập email của bạn
    .value = Cám ơn, chúng tôi sẽ giữ liên lạc.
download-back = Trở về bộ dữ liệu Common Voice
download-no = Không, cảm ơn

## Contact Modal

contact-title = Mẫu liên hệ
contact-form-name =
    .label = Tên
...
request-language-title = Yêu cầu ngôn ngữ
...
contribution-misreadings-description-extended-list-3 = Đọc các từ mà nó không thực sự ở đó, chẳng hạn như "We're" thay vì "We are" hoặc ngược lại.
...
contribution-misreadings-example-2-explanation = [Nên là 'dinosaurs']
...
contribution-misreadings-example-6-explanation = [Nên là "We are"]
contribution-misreadings-example-7-title = We are going out to get a coffee.
contribution-misreadings-example-7-explanation = [Không có ‘a’ trong văn bản gốc]
