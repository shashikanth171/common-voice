...
yes-receive-emails = Arí, correo electrónico nisqakunata apachimuwayku. Proyecto Common Voice nisqamanta willasqalla kayta munani.
...
faq-why-my-lang-a =
    Common Voice es una plataforma de crowdsourcing, y todos los idiomas fueron agregados por voluntarios.
    ¡Nos encantaría que agregaras tu idioma! <languageRequestLink>Pregunte acerca de agregar su idioma.</languageRequestLink>
faq-what-quality-q = ¿Qué nivel de calidad de audio se requiere para usar un clip de voz en la base de datos?
faq-what-quality-a = Queremos que la base de datos de Common Voice refleje la calidad de audio que un motor de voz a texto escuchará en la naturaleza, por lo que buscamos variedad. Además de una comunidad diversa de hablantes, un conjunto de datos con calidad de audio variable le enseñará al motor de voz a texto a manejar una variedad de situaciones del mundo real, desde hablar de fondo hasta el ruido del automóvil. Siempre que su clip de voz sea inteligible, debería ser lo suficientemente bueno para la base de datos.
...
download-delta-explainer = Hemos hecho algunos cambios. Los segmentos delta solo contienen los clips más recientes desde el último lanzamiento. <deltaLink>Lea más sobre este trabajo</deltaLink>.
download-dataset-tag = Seleccione los datos del idioma deseado y elija la versión que desea descargar.
download-dataset-access = Está buscando versiones anteriores de conjuntos de datos? Correo electrónico <emailLink> { $email } </emailLink>
...
sc-howto-cite-item-1 = Puede incluir el sitio web, por ejemplo, "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Puede usar el estilo de referencia académica, por ejemplo, el estilo de Harvard "Mozilla (2021) Common Voice. Disponible en https://gonthuka3.swecha.org/ (Consulta: 15 de septiembre de 2021)"
