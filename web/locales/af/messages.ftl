...
remove-info = Ons sal jou versoek om jou stemopnames uit die datastel te verwyder hersien. As jou versoek goedgekeur is, sal ons diegene wat die datastel afgelaai het kontak en versoek dat hulle jou stemopnames ook verwyder.
why-delete-recordings =
    Common Voice opnames word gebruik deur akademici, klein besighede en stemherkenning-entoesiaste om te help om openbaar-beskikbare bronne soos stemmodelle te ontwikkel.
...
sc-howto-cite-item-1 = Jy kan die webtuiste insluit, bv. "Common Voice - https://gonthuka3.swecha.org/"
sc-howto-cite-item-2 = Jy kan akademiese verwysingstyle gebruik, bv. Harvard-styl "Mozilla (2021) Common Voice. Beskikbaar by https://gonthuka3.swecha.org/ (Besoek: 15 September 2021)"
...
sc-review-form-usage = Vee regs om die sin te aanvaar. Vee links om dit te verwerp. Vee op om die sin oor te slaan. Moenie vergeet om jou evaluering in te dien nie!
# Variables:
#   $sentenceSource (Number) - Associated source the user filled out when uploading the sentence
sc-review-form-source = Bron: { $sentenceSource }
sc-review-form-button-reject = Verwerp
sc-review-form-button-skip = Slaan Oor
sc-review-form-button-approve = Keur goed
...
sc-review-form-keyboard-usage-custom = Jy kan ook kortpaaie op jou sleutelbord gebruik: { sc-review-form-button-approve-shortcut } om Goed te keur, { sc-review-form-button-reject-shortcut } om te Verwerp, { sc-review-form-button-skip-shortcut } Oor te slaan
sc-review-form-button-submit =
    .submitText = Voltooi evaluasie
# Variables:
#   $sentences (Number) - Number of sentences the user has reviewed in this session
sc-review-form-reviewed-message =
    { $sentences ->
        [0] Geen sinne hersien.
        [one] 1 sin hersien. Dankie!
       *[other] { $sentences } sinne hersien. Dankie!
    }
sc-review-form-review-failure = Die evaluasie kon nie gestoor word nie. Probeer asseblief later weer.
sc-review-link = Hersien

## SETTINGS

sc-settings-title = Instellings
sc-settings-ui-language = Koppelvlak taal
sc-settings-reset-skipped = Stel sinne wat oorgeslaan is terug
sc-settings-skipped-decription = Jy het voorheen sinne oorgeslaan tydens die hersieningsproses. Die terugstel van sinne wat oorgeslaan is, sal alle sinne wat oorgeslaan is weer wys. Dit is onafhanklik van die taal.
sc-settings-show-all-button = Wys weer alle sinne wat oorgeslaan is
sc-settings-failed = Kon nie instellings verander nie. Probeer asseblief weer.
# VALIDATION
sc-validation-number-of-words = Sinne moet tussen 1 en 14 (inklusiewe) woorde bevat
sc-validation-no-numbers = Sinne moet nie syfers bevat nie
sc-validation-no-symbols = Sinne moet nie simbole bevat nie
sc-validation-no-abbreviations = Sinne moet nie afkortings bevat nie
