...
about-no-votes-text = Hdyž wužiwar hłosowy klip wotpokazuje, wróći so k čakanskemu rynkej. Jeli so druhi raz wotpokazuje, so hłosowy klip do klipoweho kěrchowa přesunje.
...
resource-playbook-info = <playbookLink>Tu namakaće wužitne nawody</playbookLink> wo cyłym puću projekta Common Voice, wot lokalizacije do wužiwanja datowych sadźbow a wo zwisku z našim zhromadźenstwom.
...
download-recently-requested = Móžeće kóžde { $days } dnjow nowy wućah z wašich natočenjow požadać.
...
sc-howto-cite-item-1 = Wy móhł websydło podać, na př. „Common Voice - https://gonthuka3.swecha.org/“
...
sc-lang-info-rejected =
    { $rejectedSentences ->
        ...
        [one] { $rejectedSentences } wotpokazana sada.
        [two] { $rejectedSentences } wotpokazanej sadźe.
        [few] { $rejectedSentences } wotpokazane sady.
       *[other] { $rejectedSentences } wotpokazanych sadow.
    }
...
citing-sentences-subheader-websites-explanation = Wy móhł websydło podać, na př. „Common Voice - https://gonthuka3.swecha.org/“
